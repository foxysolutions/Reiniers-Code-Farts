...
Partial Public NotInheritable Class EmailVitality
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _EmailVitality As EmailVitality
    ...
    Friend Shared Property EmailVitality() As EmailVitality
        Get
            Return _EmailVitality
        End Get
        Set
            If (_EmailVitality Is Nothing) Then
                _EmailVitality = value
            Else
    ...
    Friend Shared ReadOnly Property FormRegions() As ThisFormRegionCollection
        Get
            If (_ThisFormRegionCollection Is Nothing) Then
                _ThisFormRegionCollection = New ThisFormRegionCollection(Globals.EmailVitality.GetFormRegions)
            End If
...
Partial Friend NotInheritable Class ThisFormRegionCollection
    ...
    Friend Overloads Default ReadOnly Property Item(ByVal explorer As Microsoft.Office.Interop.Outlook.Explorer) As WindowFormRegionCollection
        Get
            Return CType(Globals.EmailVitality.GetFormRegions(explorer, GetType(WindowFormRegionCollection)),WindowFormRegionCollection)
        End Get
    End Property
    ...
    Friend Overloads Default ReadOnly Property Item(ByVal inspector As Microsoft.Office.Interop.Outlook.Inspector) As WindowFormRegionCollection
        Get
            Return CType(Globals.EmailVitality.GetFormRegions(inspector, GetType(WindowFormRegionCollection)),WindowFormRegionCollection)
        End Get
    End Property
End Class
